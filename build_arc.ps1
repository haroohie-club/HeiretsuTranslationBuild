...
& $heiretsuCli generate-font-replacement -f "$assetsFolder/font/font.ttf" -s $fontSize -j "./font_replacement_map.json" -c "./src/HeiretsuTranslation/font_hack.c" -e "€ƒ…`„†‡ˆŠ‹ŒŽ‘’`“`”•–—˜™š›œžŸ¡¢£¤¦§¨©ª«¬®¯°±²³´µ·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÉËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿАБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдеёжзийклмнопрстуфхцчшщъыьэюя"
